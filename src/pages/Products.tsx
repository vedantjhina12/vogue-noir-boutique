...
const Products = () => {
  ...
  // All products from both men's and women's collections
  const allProducts = [
    // Men's products
    {
      id: 1,
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-64 bg-gray-900 flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <p className="text-lg">Discover our complete collection</p>
        </div>
      </section>
      ...
      <section className="border-b border-gray-200">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-semibold">{allProducts.length} Products</h2>
      ...
      <footer className="bg-black text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400 flex items-center justify-center gap-4">
            <img
